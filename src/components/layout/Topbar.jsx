...
const contexts = { home: 'SALES WORKSPACE', discovery: 'OPPORTUNITY', proposal: 'PROPOSAL', followup: 'FOLLOW UP', history: 'DATA', products: 'STANDARD' };
...
const Topbar = forwardRef(function Topbar({ page, onLogout, onMenu, menuOpen = false }, ref) {
  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-title"><span className="topbar-context">{contexts[page] || contexts.home}</span><h1>{title}</h1><p>{description}</p></div>
      <div className="topbar-actions">
        <span className="workspace-chip">{APP_VERSION} · PoC</span>
