...
v6는 F-01~F-05 내부 기능을 유지하면서 화면을 영업 직원의 실제 업무 흐름 중심으로 전면 재구성했습니다. v6.2는 실제 n8n 연동 전에 필요한 인증·응답 검증·상담 저장 idempotency·상태 복원·상품 catalog 일관성을 추가로 강화한 안정화 버전입니다.
